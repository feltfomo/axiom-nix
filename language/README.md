...
This directory is the source of truth for the isolated language generation. It currently exposes only its generation identity. No typed semantics exist yet.

The generation identity is `axiom-language-1`.
